      ...
      <div class="md:hidden">
          ...
          <div class="flex items-center gap-2">
            <template v-if="!isAuthenticated">
              <NuxtLink to="/auth/login"
                ><button class="px-3 py-1.5 text-xs font-medium text-gray-700 hover:text-gray-900">
                  登入
                </button></NuxtLink
              >
              <NuxtLink to="/auth/register"
                ><button
                  class="px-3 py-1.5 text-xs font-medium bg-red-500 text-white rounded-full hover:bg-red-600"
                >
                  註冊
                </button></NuxtLink
              >
        ...
        <div class="relative">
          ...
          <input
            ...
            type="text"
            placeholder="搜尋歌曲..."
            class="w-full pl-10 pr-3 py-1.5 text-sm border border-gray-200 bg-gray-100 rounded-full focus:outline-none focus:border-transparent focus:ring-2 focus:ring-red-500 focus:bg-white"
          />
        </div>
      </div>
      ...
      <div class="hidden md:flex items-center justify-between">
          ...
          <div class="flex-1 max-w-xl">
            <div class="relative">
              ...
              <input
                ...
                class="w-full pl-12 pr-4 py-2 border border-gray-200 bg-gray-100 rounded-full focus:outline-none focus:border-transparent focus:ring-2 focus:ring-red-500 focus:bg-white"
              />
            </div>
          </div>
        </div>
        <div class="flex items-center gap-4">
          <template v-if="!isAuthenticated">
            ...
            <NuxtLink to="/auth/register"
              ><button
                class="px-4 py-2 text-sm font-medium bg-red-500 text-white rounded-full hover:bg-red-600"
              >
                註冊
              </button></NuxtLink
            >
