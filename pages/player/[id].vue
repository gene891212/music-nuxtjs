...
<script setup>
import { Play, Pause, Heart, Share2, SkipBack, SkipForward, Repeat1 } from 'lucide-vue-next'
...
const highlightedLineIndex = computed(() => {
  ...
  const hasTimestamps = primaryLines.some(
    line => line.start_ms !== undefined && line.start_ms !== null
  )
