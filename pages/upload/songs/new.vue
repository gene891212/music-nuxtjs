  ...
  <div class="min-h-screen bg-gray-50 py-12 px-4">
    <div class="max-w-2xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900">新增歌曲</h1>
        <p class="mt-2 text-gray-600">輸入歌曲的基本資訊</p>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <form class="p-8 space-y-6" @submit.prevent="handleSubmit">
          ...
          <!-- 專輯 -->
          <div>
            <label for="album" class="block text-sm font-medium text-gray-700 mb-1"> 專輯 </label>
            <input
              id="album"
